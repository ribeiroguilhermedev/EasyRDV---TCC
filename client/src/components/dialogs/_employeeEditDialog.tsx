...
export default function EmployeeEditDialog({ nome, email, id, sobrenome, onDeletedUser, users, data_nascimento, rg, cpf, foto, observacao }: EmployeeEditDialogProps): JSX.Element {
