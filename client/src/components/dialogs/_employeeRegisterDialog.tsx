import { TextField, Dialog, DialogActions, DialogContent, DialogTitle, useMediaQuery } from '@mui/material'
...
export default function EmployeeRegisterDialog({ open, onClose, users, onUserCreated }: EmployeeRegisterProps): JSX.Element {
